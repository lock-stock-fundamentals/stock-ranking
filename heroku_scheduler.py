...
shed.add_job(job_function_1, 'cron', day_of_week='sun', hour=10, minute=49)  # sun (Sunday night : 2 ; 5)
shed.add_job(job_function_2, 'cron', day_of_week='mon', hour=5, minute=10)  # sun (Sunday - Monday morning)
